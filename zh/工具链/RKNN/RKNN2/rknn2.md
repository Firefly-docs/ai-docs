...
除了以上人工智能算法，更多RK官方例程请参考[rknn_model_zoo](https://github.com/airockchip/rknn_model_zoo)。同时还支持大语言模型，大语言模型部署请参考[大模型部署](../../RKLLM/index.md)这一章节
