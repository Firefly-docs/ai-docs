...
In addition to the above artificial intelligence algorithms,see [rknn_model_zoo](https://github.com/airockchip/rknn_model_zoo) for more examples.Rockchip NPU platforms also support large language models. For information on deploying large language models, please refer to the [Large Language Model](../../RKLLM/index.md) section.
